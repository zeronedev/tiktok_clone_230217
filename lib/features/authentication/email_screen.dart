...
import 'package:tiktok_clone_230217/features/authentication/password_screen.dart';
import 'package:tiktok_clone_230217/features/authentication/view_models/signup_view_model.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                  onTap: _onSubmit,
                  child: FormButton(
                      desabled: _email.isEmpty || _isEmailValid() != null)),
            ],
          ),
        ),
      ),
